package com.swein.androidkotlintool.main.examples.pdfreader.viewmodel
...
import com.swein.androidkotlintool.main.examples.pdfreader.service.PDFReaderService
...
class PDFReaderViewModel: ViewModel() {
    ...
    private val _pdfReaderViewModelState = MutableStateFlow<PDFReaderViewModelState>(PDFReaderViewModelState.None)
    ...
    private suspend fun getBitmapsFromPdfRenderer(file: File, screenWidth: Int): List<Bitmap> {
