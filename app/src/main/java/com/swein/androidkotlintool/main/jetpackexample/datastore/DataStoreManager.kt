package com.swein.androidkotlintool.main.jetpackexample.datastore
...
// top-level define
val Context.settingsDataStore: DataStore<Preferences> by preferencesDataStore(name = "whatever_name")
