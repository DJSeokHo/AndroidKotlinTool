 ...
 */
open class RectsHelper(val layoutManager: IGLayoutManager,
                       val orientation: IGLayoutManager.Orientation) {
    ...
    private val rectComparator = Comparator<Rect> { rect1, rect2 ->
        when (orientation) {
            IGLayoutManager.Orientation.VERTICAL -> {
            ...
            IGLayoutManager.Orientation.HORIZONTAL -> {
     ...
     */
    val size: Int get() {
        return if (orientation == IGLayoutManager.Orientation.VERTICAL) {
    ...
    init {
        ...
        val initialFreeRect = if (orientation == IGLayoutManager.Orientation.VERTICAL) {
    ...
    fun pushRect(position: Int, rect: Rect) {
        val start = if (orientation == IGLayoutManager.Orientation.VERTICAL)
            rect.top else
            rect.left
        ...
        val end = if (orientation == IGLayoutManager.Orientation.VERTICAL)
            rect.bottom else
            rect.right
