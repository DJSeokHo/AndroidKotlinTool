    ...
    fun scanMediaFile(context: Context, offset: Int, limit: Int,
        ...
        ILog.debug("??", "start")
            ...
            while (cursor.moveToNext()) {
                ...
                ILog.debug("???", "size is $size")
                ILog.debug("???", "dateAdded is $dateAdded")
                ILog.debug("???", "dateModified is $dateModified")
                ILog.debug("???", "displayName is $displayName")
                ILog.debug("???", "title is $title")
    ...
    fun scanFile(context: Context, offset: Int, limit: Int,
        ...
        contentResolver.query(
            ...
            while (cursor.moveToNext()) {
                ...
                ILog.debug("???", "imageUri is $imageUri")
